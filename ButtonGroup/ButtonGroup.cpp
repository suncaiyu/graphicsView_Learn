...
void ButtonGroup::addButton(QAbstractButton *btn, int id)
{
    ...
    qss.append(
        QString(
            "QAbstractButton{border:none;background:rgba(%1,%2,%3,%4);color:rgba(%5,%6,%7,%8);}")
            .arg(btnNormalColor.red())
            .arg(btnNormalColor.green())
            .arg(btnNormalColor.blue())
            .arg(btnNormalColor.alpha())
            .arg(textNormalColor.red())
            .arg(textNormalColor.green())
            .arg(textNormalColor.blue())
            .arg(textNormalColor.alpha()));
    qss.append(
        QString("QAbstractButton:hover{background:rgba(%1,%2,%3,%4);color:rgba(%5,%6,%7,%8);}")
            .arg(btnHoverColor.red())
            .arg(btnHoverColor.green())
            .arg(btnHoverColor.blue())
            .arg(btnHoverColor.alpha())
            .arg(textHoverColor.red())
            .arg(textHoverColor.green())
            .arg(textHoverColor.blue())
            .arg(textHoverColor.alpha()));
    qss.append(QString("QAbstractButton:pressed,QAbstractButton:checked{background:rgba(%1,%2,%3,%"
                       "4);color:rgba(%5,%6,%7,%8);}")
                   .arg(btnDarkColor.red())
                   .arg(btnDarkColor.green())
                   .arg(btnDarkColor.blue())
                   .arg(btnDarkColor.alpha())
                   .arg(textDarkColor.red())
                   .arg(textDarkColor.green())
                   .arg(textDarkColor.blue())
                   .arg(textDarkColor.alpha()));
...
void ButtonGroup::SetHeight(int height)
{
    for (QAbstractButton *btn : btns) {
        btn->setFixedHeight(height - lineLen);
    }
